					...
					<div class="layui-card">
						...
						<div class="layui-card-body">
							...
							<div class="test-table-reload-btn" style="margin-bottom: 10px;">
								<button class="layui-btn layui-btn-primary" id="insert"><i class="layui-icon">&#xe654;</i>新增图片</button>
								<div class="layui-input-inline">
									<div class="demoTable">
										<div class="layui-inline">
											<input class="layui-input" name="title" id="demoReload" autocomplete="off" placeholder="请输入链接地址...">
										</div>
		...
		<script>
			layui.config({
				...
				var dicTable = table.render({
					...
					url: '${BASE_PATH}/front/wxuser/bannerlist',
					page: true, //开启分页
					limit: 10,
				...
				table.on('tool(shop)', function(obj) {
					...
					if(obj.event === 'info') {
						layer.open({
							...
							shade: 0.8,
							area: ['90%', '90%'],
							content: 'banner_list?bannerId=' + bannerId
						});
					}
					if(obj.event === 'del') {
