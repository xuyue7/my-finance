			...
			<div class="layui-row layui-col-space15">
				<div class="layui-col-md12">
					<div class="layui-card">
						<div class="layui-card-header">编辑帖子分类</div>
							...
							<div class="layui-form" lay-filter="">
								<div class="layui-form-item">
									...
									<div class="layui-input-inline">
										<input type="text" id="content" value="${postType.typeName}"  lay-verify="title" class="layui-input">
									</div>
								</div>
								
					<div class="layui-upload">
						<label class="layui-form-label" >分类图片</label>
						<button type="button" class="layui-btn layui-btn-normal" id="picturef">更换图片</button>
						<div class="layui-upload-list">
							<input type="hidden" lay-verify="picture" name="picturef" id="company_logo_int1" value="" />
						</div>

								<div id="company_logo_img1" class="tupian" style="margin-left: 25%;">
									<img class="images" src="${BASE_PATH}/${postType.imag}" style="width: 200px;height:200px;"/>
						</div>
		...
		<script>
			...
			var uploadInst = upload.render({
				...
				url: '${BASE_PATH}/admin/postType/photo.json' //上传接口
					...
					if(res.success === true) {
						$("#company_logo_img1").html('<img src="${BASE_PATH}/' + res.t + '"  style="width: 200px;height:200px;"/>');
      ...
      ,content: function(value){
        layedit.sync(editIndex);
			...
			form.on("submit(demo1)", function(data) {
				...
				$.ajax({
					url: '${BASE_PATH}/admin/postType/doUpdate',
					type: 'post',
					async: false,
					data: {
					typeName:content,
