							...
							<div class="layui-form" lay-filter="">
								<div class="layui-form-item">
									...
									<!--<input type="hidden" id="infromId" name="infromId" value="${entity.infromId}">-->
										...
										<input type="hidden" name="aqsId" value="${entity.aqsId}" class="layui-input">
										<input type="text" name="aqsContent" value="${entity.aqsContent}" lay-verify="taskTitle" class="layui-input" placeholder="请输入问题标题">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label">问题答案<span style="color: red;">*</span></label>
									<div class="layui-input-inline" style="width:80%"><textarea name="aqsAnswer" id="editor">${entity.aqsAnswer}</textarea></div>
								</div>
								<!--新增-->
								<div class="layui-form-item">
									<label class="layui-form-label">创建人<span style="color: red;">*</span></label>
									<div class="layui-input-inline">
										<input type="text" name="aqsUserName" value="${entity.aqsUserName}" lay-verify="taskTitle" class="layui-input" placeholder="请输入编辑人">
									</div>
								</div>
		...
		<script>
			layui.use(['jquery', 'form', 'layer', 'upload','jquery'], function() {
				...
				form.on('submit(ff)', function(data) {
					$.ajax({
						type: 'get',
						url: '${BASE_PATH}/admin/operate/aqs_edit_add',
						data: data.field,
