									...
									<div class="layui-input-inline">
										...
										<div class="layui-btn">
											...
											<div class="layui-inline">
												<input class="layui-input" id="demoReload" autocomplete="off" placeholder="请输入客服姓名...">
											</div>
		...
		<script>
			layui.config({
				...
				var dicTable = table.render({
					...
					url: '${BASE_PATH}/admin/customer/customer_index_data',
					page: true, //开启分页
					limit: 10,
					...
					if(obj.event === 'del') {
						var index = layer.confirm('您确认要删除吗？', {
						  btn: ['确认','取消'] //按钮
								...
								$.ajax({
				                   url:'${BASE_PATH}/admin/customer/customer_del',
				                   data:{id:id},
				...
				$("#add").click(function(){
					layer.open({
							...
							shade: 0.8,
							area: ['50%', '75%'],
							content: '${BASE_PATH}/admin/customer/add_page'
						});
				})
